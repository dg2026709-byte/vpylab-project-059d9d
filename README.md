...
- 🌐 [GitHub Pages 실행 페이지](https://dg2026709-byte.github.io/vpylab-project-059d9d/)
- ▶️ [VPyLab에서 이 코드 실행](https://vpylab.vercel.app/sandbox?repo=dg2026709-byte%2Fvpylab-project-059d9d&autorun=1)
...
또는 GitHub에서 [`Commits`](https://github.com/dg2026709-byte/vpylab-project-059d9d/commits/main) 탭 클릭.
